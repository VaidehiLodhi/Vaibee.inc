  ...
  return (
    <div className={`${magnat_test_light.className} w-full max-h-full flex flex-col`}>
      ...
      <div className="flex flex-col">
        <div className="pt-2 px-3 md:px-5 pb-6 md:pb-12 flex flex-col gap-2 md:gap-4">
        ...
        {/* Tools and Stack */}
        <div className={`${magnat_text_light.className} py-4 md:py-12`}>
          <div className="text-xs md:text-sm py-1.5 text-center border border-dashed border-black">
            Tools and Stack
          </div>

          {/* Web Dev */}
          <div className="border border-dashed border-black border-t-0 border-b-0 mb-4 md:mb-6">
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="flex w-full border-t border-dashed border-black">
                <div className="border-r w-1/2 border-black border-dashed text-xs md:text-sm pl-3 md:pl-8 py-1">
                  React
                </div>
                <div className="w-1/2 text-xs md:text-sm pl-3 md:pl-8 py-1">Next.JS</div>
              </div>
              <div className="flex w-full border-t border-b border-dashed border-black">
                <div className="border-r w-1/2 border-black border-dashed text-xs md:text-sm pl-3 md:pl-8 py-1">
                  TanStack Ecosystem
                </div>
                <div className="w-1/2 text-xs md:text-sm py-1 pl-3 md:pl-8">
                  NoSQL/SQL Databases
                </div>
              </div>
            </div>
          ...
          <div className="border border-dashed border-black border-t-0 border-b-0 mb-4 md:mb-6">
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="flex w-full border-t border-b border-dashed border-black">
                ...
                <div className="w-1/2 text-xs md:text-sm pl-3 md:pl-8 py-1">PyTorch</div>
              </div>
            </div>
          </div>
          ...
          <div className="border border-dashed border-black border-t-0 border-b-0 mb-4 md:mb-6">
            <div className="flex flex-col items-center justify-center">
              <span className="text-[10px] text-center py-1.5">Design Tools</span>
              <div className="flex w-full border-t border-b border-dashed border-black">
                <div className="w-full text-xs md:text-sm pl-3 md:pl-8 py-1">Figma</div>
              </div>
            </div>
          </div>
          ...
          <div className="border border-dashed border-black border-t-0 border-b-0 mb-4 md:mb-6">
            <div className="flex flex-col items-center justify-center">
              <span className="text-[10px] text-center py-1.5">Languages</span>
              <div className="flex w-full border-t border-dashed border-black">
                <div className="border-r w-1/2 border-black border-dashed text-xs md:text-sm pl-3 md:pl-8 py-1">
                  Javascript
                </div>
                <div className="w-1/2 text-xs md:text-sm pl-3 md:pl-8 py-1">Typescript</div>
              </div>
              <div className="flex w-full border-t border-b border-dashed border-black">
                <div className="border-r w-1/2 border-black border-dashed text-xs md:text-sm pl-3 md:pl-8 py-1">
                  Python
                </div>
                <div className="w-1/2 text-xs md:text-sm py-1 pl-3 md:pl-8">C++</div>
              </div>
            </div>
          </div>
